...
namespace Generateur_Code_QR
{
    ...
    {
        {ECLevel.L, new Dictionary<int, GroupBlockCodewordHelper>()     //int ici représente la version
        {
        ...
        /// <summary>
        /// Retourne la version un dictionnaire permettant d'avoir le nombre de blos par groupe et le nombre de codeWord par bloc, alors le total des données
        /// </summary>
        /// <param name="ec"></param>
